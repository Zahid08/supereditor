                     ...
                     <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url() ?>User/save_user_data" autocomplete="off">
                           <div class="row">
                              ...
                              <div class="col-sm-6">
                                 <input class="form-control" name="mobile" id="mobile" pattern="[7-9]{1}[0-9]{9}" title="Please enter valid Phone number with 7-9 and remaining 9 digit with 0-9" placeholder="Mobile" required>
                              </div>
                              <div class="col-sm-6">
