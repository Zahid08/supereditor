    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">Code Generation</h3>
            </div>
        ...
        <div class="container-fluid">
            ...
            <section id="po_section" name="po_section">
                <button type="button" class="btn btn-sm btn-primary btn-block text-white" data-toggle="collapse" data-target="#customerform" >Code Generation</button>
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                        <div class="row" style="border-style: ridge;">
                                            ...
                                            <div class="col-sm-2" style="padding: 0;margin-top: 23px;">
        ...
        $( document ).ready(function() {
	     ...
	     $(document).on('change', 'select#company_name', function() {
            ...
            function addCodesInlist() {
                ...
                var pattern                  = $('select#patterns_type').val();
