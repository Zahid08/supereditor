               ...
               <div id="addRole" class="collapse in">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <form method="post" action="<?php echo base_url() ?>Measure/save_measure_data" autocomplete="off">
                           <div class="row">
                              <div class="col-sm-6">
                                 <input class="form-control" name="name" id="name"  placeholder="Measure Name" required>
                              </div>
                               <div class="col-sm-6">
                                 <input class="form-control" name="short_code" id="name"  placeholder="Short Code" required>
                              </div>
