      ...
      <div class="page-wrapper">
         ...
         <div class="container-fluid">
            ...
            <section id="communication_section" name="communication_section">
               <button type="button" class="btn btn-primary btn-block text-white" data-toggle="collapse" data-target="#sms_section" >Communication</button>
               <div id="sms_section" class="collapse in">
                  <div class="card">
                     <div class="card-body">
                        <center>
                        ...
                        <form method="post" action="<?php echo base_url() ?>Communication/save_sms_data" autocomplete="off" enctype='multipart/form-data'>
                           <div class="row">
                              <div class="col-sm-12"> 
                               ...
                               <div class="col-sm-12">
                                 <input class="form-control" type="text" name="addon_mob" id="addon_mob" placeholder="Any Other Mobile Numbers : (use comma to separate more than one mobile #)">
                              </div>
                              <div class="col-sm-12">
                                 <textarea class="textarea_editor form-control" rows="10" placeholder="Enter text ..." name="sms_content" id="sms_content" style="height:300px" required></textarea>
                              </div>
                              <div class="col-sm-12">
                                 <br><button type="submit" class="btn btn-primary  text-white" >Save and Send Whatsapp Msg</button> 
                              </div>
                           </div>
                        </form>
                     </div>
