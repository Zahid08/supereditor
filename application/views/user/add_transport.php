...
$purchaseTransID = $_GET['purchase_transport_id'];
   ...
   $ExistingtransportDetails = $this->db->query("SELECT * FROM purchase_transport pt INNER JOIN transport t 
                                                ...
                                                WHERE pt.is_active = 1 and pt.purchase_transport_id = $purchaseTransID ")->result();
                     ...
                     <form method="post" action="<?php echo base_url() ?>Purchase/save_purchase_transport_data" autocomplete="off">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-4 mt-2">
                              ...
                              <input class="form-control" type="number"  name="lr_amout" id="lr_amout" placeholder="L.R.Amount" value="<?php echo $total_lr_amt ?>" readonly >  
                           </div>
                           <div class="col-sm-4 mt-2">
                           ...
                           <div class="col-sm-4 mt-2">
                              ...
                              <input class="form-control" type="number" name="gst_tpt" id="gst_tpt" value="<?php echo $trans_gst ?>"  placeholder="GST % Tpt" readonly >
                           </div>
                              
                           <div class="col-sm-4 mt-2">
                              <label>IGST (%) On Transport</label>
                              <input class="form-control" type="number" name="igst_tpt" id="igst_tpt" value="<?php echo $trans_igst ?>" placeholder="IGST Tpt"  readonly>
                           </div>
                           <div class="col-sm-4 mt-2">
                              <label>CGST (%) On Transport</label>
                              <input class="form-control" type="number" name="cgst_tpt" id="cgst_tpt" value="<?php echo $trans_cgst ?>" placeholder="CGST Tpt" readonly>
                           </div>
                           <div class="col-sm-4 mt-2">
                              <label>SGST (%) On Transport</label>
                              <input class="form-control" type="number" name="sgst_tpt" id="sgst_tpt" value="<?php echo $trans_sgst ?>" placeholder="Total SGST" readonly>
                           </div>
                           <div class="col-sm-4 mt-2">
                              <label>Total Tax On Transport</label>
                              <input class="form-control" type="number" name="total_tpt_tax" id="total_tpt_tax" value="<?php echo $trans_total_tax; ?>" placeholder="Total Tax" readonly  >
                           </div>
                           <div class="col-sm-4 mt-2"> 
                           ...
                           <div class="col-sm-4 mt-2"> 
                              ...
                              <input class="form-control" type="number" name="net_amount" id="net_amount" value="<?php echo $trans_net_amount ?>" placeholder="Net Amount"  readonly >
                           </div>
                        </div>
                        <div class="col-sm-12">
                           <p>&nbsp;</p>
